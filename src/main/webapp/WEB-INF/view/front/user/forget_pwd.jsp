...
<body>
    ...
    <main>
        <div class="container">
            <form class="ma" action="/maven-project/front/user/forgetpwd.action" method="post" >
                <div class="form_header">
                    ...
                    <div class="form_back">
                        <a href="/maven-project/front/user/noseLogin.action">返回立即登录</a>
                    </div>
                </div>
                <div class="form_body">
    ...
    <script type="text/javascript">
		function submitEmail(){
			...
			if(email!=null&&email!=''){
				...
				$.post('/maven-project/front/user/sendemail.action',{email:email},function(data){
					console.log(data);
