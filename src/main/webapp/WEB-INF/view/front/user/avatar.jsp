...
<head>
    ...
    <link rel="stylesheet" href="/maven-project/static/css/bootstrap.min.css">
                    ...
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                            <c:if test="${empty user.headUrl}">
                                 <img  src="/maven-project/static/img/avatar_lg.png">
                            </c:if>
                        ...
                        <div class="profile_ifo_area">
                            <form id="upload_form" enctype="multipart/form-data" method="post" action="/maven-project/front/user/avatar.action" >
                                <p>请选择图像文件</p>
                                <div>
