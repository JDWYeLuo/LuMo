...
<html>
    ...
    <div class="container">
  <form class="form-horizontal" action="${pageContext.request.contextPath}/admin/course/addCourse02.action" method="post">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="courseName" id="input02" placeholder="课程标题">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      <textarea class="form-control" rows="5" name="courseDescr" ></textarea>
    </div>
  </div>
